$(document).ready(function () {
	var assfoldername = $('#themes')[0].getAttribute('assets-id');
...
//        	var themeinfo = assfoldername+'/bower_components/bootstrap/dist/css/bootstrap.min.css';
//            $('#bs-css').attr('href', themeinfo);
        } else {
        	var themeinfo = assfoldername+'/css/bootstrap-' + themeName + '.min.css';
            $('#bs-css').attr('href', themeinfo);
        }
