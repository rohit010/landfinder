...
<head>
    <!--
        ...
        Copyright 2012-2014 LandFinder.in
    ...
    <meta name="author" content="LandFinder.in">
        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="glyphicon glyphicon-user"></i><span class="hidden-sm hidden-xs"> <?= Yii::app()->user->name; ?></span>
            ...
            <div class="btn-group pull-right theme-container animated tada">
                ...
                <ul class="dropdown-menu" id="themes" assets-id="<?php echo $this->assetsBase; ?>">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-plus"></i><span> External Users</span></a>
                            <ul class="nav nav-pills nav-stacked" style="display: block;">
                                <li>
                                	<a class="ajax-link" href="AddUser"><i class="glyphicon glyphicon-edit"></i><span> Add Vender</span></a>
                                </li>
                                <li>
		                        	<a class="ajax-link" href="ManageUsers"><i class="glyphicon glyphicon-align-justify"></i><span> Manage Users</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
...
<div class="row">
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://usman.it" target="_blank">LandFinder.in</a> 2012 - 2014</p>
    </footer>
