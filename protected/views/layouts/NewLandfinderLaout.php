...
<html>
	<head>
		<?php Yii::app()->getClientScript()->registerCssFile($this->assetsBase.'/css/style_new.css'); ?>
		<?php Yii::app()->getClientScript()->registerCssFile($this->assetsBase.'/bootstrap/css/bootstrap.min.css'); ?>
		<?php Yii::app()->getClientScript()->registerCssFile('http://fonts.googleapis.com/css?family=Montserrat:400,700'); ?>
