...
class SiteController extends Controller
{
	...
	{
		$DataList = array();
		$sql = "SELECT l.list_id, cn.category_name,l.price,l.rate,l.property_title,l.land_location,l.property_type,l.area,l.area_unit,l.name,l.posted_date,u.user_logo,l.image_locator,u.uid
				FROM listing l
